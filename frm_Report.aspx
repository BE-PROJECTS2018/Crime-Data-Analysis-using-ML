<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_Report.aspx.cs" Inherits="My_Application.frm_Report" EnableEventValidation="false" %>
...
<body bgcolor="#eeebe4">
    ...
    style="background-color: #FFFFFF; height: 856px; width: 1027px;">
    <div id="centered" style="border-color: #99CCFF; height: 785px;">
    <div>
    
        <div style="text-align: left">
            <br />
                <asp:Image ID="Image1" runat="server" Height="78px" ImageUrl="~/IMG/MyCompanyLogo.png"
                    Width="252px" Style="text-align: center" />
                    ...
                    <tr>
                        ...
                        <td class="style25">
                            <telerik:RadComboBox ID="ddlProcess" Runat="server" Skin="Sunset">
                                <Items>
                                    <telerik:RadComboBoxItem runat="server" Text="Local Booking" 
                                        Value="sp_report_LocalTicket" />
                                    <telerik:RadComboBoxItem runat="server" Text="Express Booking" 
                                        Value="sp_report_ExpressTicket" />
                                    <telerik:RadComboBoxItem runat="server" Text="User List" 
                                        Value="sp_Report_UserList" />
                                    <telerik:RadComboBoxItem runat="server" Text="Existing User List" 
                                        Value="sp_Report_UserList" />
                                    <telerik:RadComboBoxItem runat="server" Text="ResetPassword" 
                                        Value="sp_Report_SYSGeneratePassword" />
                                </Items>
                    ...
                    <tr>
                        ...
                        <td class="style25">
                            <telerik:RadDateTimePicker ID="dtpFrom" Runat="server" 
                                ...
                                <DateInput DateFormat="d-MMM-yyyy  hh:mm tt">
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
                    ...
                    <tr>
                        ...
                        <td class="style17">
                            &nbsp;</td>
                        <td class="style19">
                            <asp:Button ID="Button1" runat="server" Height="17px" onclick="Button1_Click" 
                                Text="." />
                                </td>
                        <td class="style12">
                            &nbsp;</td>
    ...
    <table style="width:100%; height: 421px;" align="center">
        <tr>
            <td>
